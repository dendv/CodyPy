...
# наверх, по горизонтали и т.д.” (см. рисунок). Кроме того, чтобы шнурки можно было
...
print('Введи расстояние между рядами (см):')
a = int(input())
print('Введи расстояние между дырочками (см):')
b = int(input())
print('Введи длинну свободного конца шнурка (см):')
l = int(input())
print('Введи количество дырочек в каждом ряду:')
N = int(input())
print('Требуемая длина шнурка:', (N*2-1)*a+((N-1)*2)*b+l*2, 'см')
